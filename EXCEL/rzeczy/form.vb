...
If k = "" Then
    MsgBox "Nie wybrano przedmiotu", , "Błąd"
Else
    If form.data.Text = "" Then
        MsgBox "Nie wprowadzono daty, spróbuj ponownie", , "Błąd"
    Else
      '  x = 0
       ' While x < 20
...
Else
    MsgBox "Wprowadzono nie poprawnie dane, spróbuj raz jeszcze", , "Błąd"
End If
    Else
        MsgBox "Wybierz 1 grupę", , "Błąd"
End If
End If
End If
End Sub
